...
S310_PLATFORMS = morpheus_PVT1 pill_PVT1 pillx_EVT1 morpheusx_EVT1 pillx_DVT1
...
%.crc: %.bin tools/crc16
	cat $< | openssl dgst -binary -sha1 -mac HMAC -macopt hexkey:3c44662f28a1c4d3b2f293f8e0d4be78 >> $<
	echo 01 00 | xxd -r -p >> $@
