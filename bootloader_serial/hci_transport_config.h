...
#define HCI_SLIP_UART_RX_PIN_NUMBER  CCU_RX_PIN                      /**< Defines the UART RX pin number. The default pin for the board is chosen, but can be overwritten. */

#define HCI_SLIP_UART_TX_PIN_NUMBER  CCU_TX_PIN                      /**< Defines the UART TX pin number. The default pin for the board is chosen, but can be overwritten. */

#define HCI_SLIP_UART_RTS_PIN_NUMBER CCU_RTS_PIN                     /**< Defines the UART RTS pin number. The default pin for the board is chosen, but can be overwritten. */

#define HCI_SLIP_UART_CTS_PIN_NUMBER CCU_CTS_PIN                     /**< Defines the UART CTS pin number. The default pin for the board is chosen, but can be overwritten. */
