...
#define HLO_ANT_DEVICE_TYPE_PILL1_5   (HLO_ANT_DEVICE_TYPE_PILL_BASE + 2)
#define HLO_ANT_DEVICE_TYPE_PILL1_9   (HLO_ANT_DEVICE_TYPE_PILL_BASE + 3)
#define HLO_ANT_DEVICE_TYPE_SENSE     (HLO_ANT_DEVICE_TYPE_SENSE_BASE + 1)
#define HLO_ANT_DEVICE_TYPE_SENSE1_5  (HLO_ANT_DEVICE_TYPE_SENSE_BASE + 2)
