...
static const uint8_t CONF_MEAS1[3] = { 0x08, 0x13, 0x00 };
static const uint8_t CONF_MEAS4[3] = { 0x0B, 0x73, 0x00 }; //72
...
static void _poll_prox(uint8_t mask){
    uint16_t res = 0; 
    uint16_t timeout = 4;
    timeout = 4;
    do {
