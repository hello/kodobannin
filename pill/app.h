...
#define HEARTBEAT_INTERVAL_SEC              (3600/60)
#define BATTERY_INTERVAL_SEC                (600/60)
#define MOTION_DATA_INTERVAL_SEC            (60/60)
#define BATT_MEASURE_INTERVAL_SEC           (1200/60)  /* Measure battery level every 20 minutes */
