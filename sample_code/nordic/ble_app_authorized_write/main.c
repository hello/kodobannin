...
#define DEVICE_NAME                   "Nordic_wr_test"                           /**< Name of device. Will be included in the advertising data. */
...
static bool                     m_is_notifying_enabled = true;                     /**< Variable to indicate whether the notification is enabled by the peer.*/
