// From <https://code.google.com/p/smallsha1/>

// Rotate an integer value to left.
/* static inline const unsigned int rol(const unsigned int value, */
/* 				     const unsigned int steps) __attribute__((always_inline)); */
static inline const unsigned int rol(const unsigned int value,
...
/* static inline void clearWBuffert(unsigned int* buffert) __attribute__((always_inline)); */
